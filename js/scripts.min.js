...
d(b.previousSibling);b.$_button=d('<button type="button" aria-controls="'+a+'" aria-haspopup="true" aria-expanded="false" aria-hidden="true"/>').text(b.$_link.text()).click(g);b.$_button.addClass(b.$_link.attr("class"));d(b).before(b.$_button).attr("id",a)});x=d("#hero .hero-navigation").clone().attr("aria-label","Quicklink Navigation");d('<div class="cloned-hero-nav"></div>').append(x).prependTo("#footer");var l=d(".sidebar-subnav");if(l=l.length?l[0]:null)l._origParentNode=l.parentNode;var e=d("ul.meta-nav"),
