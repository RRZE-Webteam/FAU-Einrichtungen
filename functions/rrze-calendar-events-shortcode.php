...
add_filter('rrze-calendar-events-shortcode', function($content, $dates, $subscribe_url) {
    ob_start();
    ?>
    <div class="events-list">
        ...
        <p class="events-more-links">
            <a class="events-more" href="<?php echo RRZE_Calendar::endpoint_url(); ?>"><?php _e('Mehr Veranstaltungen', 'fau'); ?></a>
        </p>                      
        </div>
        <?php endif; ?>
