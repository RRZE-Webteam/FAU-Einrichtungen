<?php
    ...
    $defaultoptions = [
        ...
        'advanced_comments_notes_before'          => __( 'Ihre E-Mail-Adresse wird nicht angezeigt. Verpflichtende Felder werden mit dem folgenden Zeichen markiert: <span class="required">*</span>',
            'fau' ),
        'advanced_comments_disclaimer'            => __( 'Hinweis: Die Kommentare wurden von Lesern geschrieben und spiegeln deren persönliche Meinung wieder. Sie müssen nicht die Meinung der Universität oder der Fakultät repräsentieren.',
            'fau' ),
        ...
        'search_notice_searchregion'               => __( 'Es wird nur in diesem Webauftritt gesucht. Um Dokumente und Seiten aus anderen Webauftritten zu finden, nutzen Sie bitte die jeweils dort zu findende Suchmaschine oder verwenden eine Internet-Suchmaschine.',
            'fau' ),
    ...
    foreach ( $categories as $category ) {
        if ( ! is_wp_error( $category ) ) {
            $currentcatliste[ $category->cat_ID ] = $category->name . ' (' . $category->count . ' ' . __( 'Einträge',
                    'fau' ) . ')';
        }
    }
    /*--------------------------------------------------------------------*/
            ...
            'title_tagline' => array(
                ...
                'fields' => array(
                    ...
                    'website_logotitle'  => array(
                        ...
                        'label'       => __( 'Bei Einrichtungen der FAU wird der Titel neben dem FAU-Logo gezeigt. Ist der Titel zu lang um ihn optisch korrekt darzustellen, kann hiermmit ein kürzerer Titel angegeben werden. Wird dieser EIntrag leer gelassen, wird der Titel der Website verwendet.',
                            'fau' ),
                        'default'     => '',
                        'input_attrs' => array(
                            'maxlength' => 80,
                    ...
                    'website_type' => array(
                        'type'    => 'select',
                        'title'   => __( 'Typ', 'fau' ),
                        'label'   => __( 'Bitte wählen Sie hier aus, um welcherart Webauftritt es sich handelt.',
                            'fau' ),
                        'liste'   => array(
                    ...
                    'startseite_banner_image' => array(
                        ...
                        'label'     => __( 'Festes Banner für die Startseite (Template für Lehrstühle und Einrichtungen)',
                            'fau' ),
                        'parent'    => 'title_tagline',
                        'default'   => '',
                    ),
            ...
            'allgemeines' => array(
                ...
                'fields'     => array(
                    ...
                    'advanced_display_postthumb_credits' => array(
                        ...
                        'label'   => __( 'In Beiträgen wird das Artikelbild mit einem Copyright-Hinweis des Bildes versehen, wenn ein solcher Hinweis vorhanden ist.',
                            'fau' ),
                    ...
                    'advanced_activate_post_comments' => array(
                        ...
                        'label'   => __( 'Schaltet die Kommentarfunktion für Beiträge ein. Die Kommentare erscheinen unterhalb des Artikels. Bitte beachten Sie, daß diese Darstellung von Kommentarfunktionen ebenfalls von den Diskussions-Einstellungen abhängig sind.',
                            'fau' ),
                    ...
                    'advanced_display_postthumb_alt-from-desc' => array(
                        ...
                        'label'   => __( 'Bei der Darstellung des Artikelbildes wird das ALT-Attribut vom Inhalt der Bildbeschreibung gefüllt, wenn das ALT-Attribut leer ist.',
                            'fau' ),
                    ...
                    'slider-catid' => array(
                        ...
                        'label'   => __( 'Bitte wählen Sie die Kategorie der Artikel aus, die im Slider erscheinen sollen.',
                            'fau' ),
                    ...
                    'fallback-slider-image'       => array(
                        ...
                        'label'     => __( 'Ersatzbild für den Slider, für den Fall, daß ein Artikel kein eigenes Artikel- oder Bühnenbild definiert hat.',
                            'fau' ),
                        'parent'    => 'slider'
                    ),
                    'fallback-slider-image-title' => array(
                        ...
                        'label'   => __( 'Optionaler Titel bzw. Copyright-Info für das Ersatzbild für den Fall, daß es sich um ein geschnittenes Originalbild handelt.',
                            'fau' ),
                        'default' => '',
                        'parent'  => 'slider'
                    ),
                    ...
                    'galery_link_original'         => array(
                        ...
                        'label'   => __( 'Bei der Anzeige einer Defaultgalerie unter der Bildunterschrift eine Verlinkung auf das Originalbild einschalten',
                            'fau' ),
                    ...
                    'galery_force_caption_onslick' => array(
                        ...
                        'label'   => __( 'Bei der Darstellung von Bildergalerien mit dem Slider werden die Bildbeschriftungen immer unterhalb des aktiven Bildes angezeigt.',
                            'fau' ),
                    ...
                    'advanced_header_template' => array(
                        ...
                        'label'   => __( 'Auf Index- und Kategorieseite wird üblicherweise ein Kopfteil wie bei normalen Seiten mit einer Breadcrumb gezeigt. Stattdessen kann man jedoch auch die Darstellung des Banners von Startseiten auswählen.',
                            'fau' ),
                        'liste'   => array(
                    ...
                    'advanced_footer_display_socialmedia' => array(
                        ...
                        'label'   => __( 'Zeigt die Social Media Icons im Footerbereich unterhalb des technischen Menüs an',
                            'fau' ),
                    ...
                    'socialmedia'                         => array(
                        ...
                        'label'   => __( 'Schaltet die Social Media Buttons in der Widgetspalte an oder aus. Bitte beachten Sie, daß die anzuzeigenden Icons selbst als Menü verwaltet werden. Rufen Sie hierzu die Menüeinstellungen auf und bearbeiten dort das Social Media Menü.',
                            'fau' ),
                        'parent'  => 'footer',
                    ...
                    'advanced_footer_display_address' => array(
                        ...
                        'label'   => __( 'Zeigt die Postadresse an, wie sie bei den Inhaltsdaten des Webauftritts angegeben wurde.',
                            'fau' ),
                    ...
                    'start_max_newspertag'      => array(
                        ...
                        'label'   => __( 'Anzahl der Artikel mit dem gleichen Prefix-Tag (Positionierung), die angezeigt werden sollen. Normalerweise sollte hier nur 1 Artikel auf der ersten Position sein.',
                            'fau' ),
                        'min'     => 1,
                        'max'     => 5,
                    ...
                    'start_link_news_cat'       => array(
                        ...
                        'label'   => __( 'Unter den News erscheint ein Link auf eine Übersicht der Artikel. Hier wird die Kategorie dafür ausgewählt. Für den Fall, dass keine Artikel mit einem Prefix-Tag ausgestattet sind, wird diese Kategorie auch bei der Anzeige der ersten News verwendet.',
                            'fau' ),
                    ...
                    'default_postthumb_always' => array(
                        ...
                        'label'   => __( 'Immer ein Artikelbild zu einer Nachricht zeigen. Wenn kein Artikelbild definiert wurde, nehme stattdessen ein Ersatzbild.',
                            'fau' ),
                    ...
                    'default_postthumb_image' => array(
                        ...
                        'label'     => __( 'Ersatzbild für den Fall, daß ein Artikel kein eigenes Artikelbild definiert hat.',
                            'fau' ),
                        'parent'    => 'newsbereich'
                    ),
                    ...
                    'default_display_thumbnail_3_2' => array(
                        ...
                        'label'   => __( 'Artikelbilder der Artikelliste werden in ein festes 3:2 Format angezeigt. Sollten die Bilder höher oder Breiter sein, werden sie entsprechend proportional verkleinert.',
                            'fau' ),
                    ...
                    'topevents_templates' => array(
                        ...
                        'label'   => __( 'Auf welchen Seiten sollen Top Events in der Sidebar angezeigt werden.',
                            'fau' ),
                        'liste'   => array(
                            1 => __( 'Startseite', 'fau' ),
                            2 => __( 'Portalseiten', 'fau' ),
                    ...
                    'fallback_topevent_image' => array(
                        ...
                        'label'     => __( 'Ersatzbild für den Fall, daß für den Eventeintrag kein eigenes Bild definiert wurde.',
                            'fau' ),
                        'parent'    => 'topevents'
                    ),
                    ...
                    'search_display_post_thumbnails'    => array(
                        ...
                        'label'   => __( 'Bei den Suchergebnisse Thumbnails anzeigen, wenn diese vorhanden sind',
                            'fau' ),
                    ...
                    'default_search_excerpt_length'     => array(
                        ...
                        'label'   => __( 'Anzahl der maximalen Zeichen für den Textauszug bei der Ergebnisliste.',
                            'fau' ),
                    ...
                    'search_display_excerpt_morestring' => array(
                        ...
                        'label'   => __( 'Falls der Textauszug nach der vorgegebenen Länge abgeschnitten werden muss, können hier Trennzeichen angegeben werden.',
                            'fau' ),
                    ...
                    'search_allowfilter'         => array(
                        ...
                        'label'   => __( 'Erlaubt es, Suchergebnisse nach der Art des Dokumenttypes (Seiten, Beiträge, etc.) zu filtern.',
                            'fau' ),
                    ...
                    'search_post_types_checked'  => array(
                        'type'    => 'multiselectlist',
                        'title'   => __( 'Filter', 'fau' ),
                        'label'   => __( 'Vorab aktivierte Suchbereiche des Filters. In diesen wird gesucht, wenn der Nutzer der Seite keine Auswahl trifft oder diese nicht zur Verfügung gestellt wird.',
                            'fau' ),
                        'liste'   => array(
                            "page"       => __( 'Seiten', 'fau' ),
                            "post"       => __( 'Artikel', 'fau' ),
                    ...
                    'search_notice_searchregion' => array(
                        ...
                        'label'   => __( 'Für Besucher der Website ist oft nicht klar, daß die Suchmaschine nur den einzelnen Webauftritt durchsucht und nicht beispielsweise alle Seiten der FAU. Dieser Texthinweis macht darauf aufmerksam.',
                            'fau' ),
            ...
            'advanced' => array(
                ...
                'fields'     => array(
                    ...
                    'advanced_beitragsoptionen' => array(
                        ...
                        'label'   => __( 'Bei der Bearbeitung von Beiträgen die erweiterten Optionen anzeigen.',
                            'fau' ),
                    ...
                    'advanced_topevent'         => array(
                        'type'    => 'toggle',
                        'title'   => __( 'Top-Events', 'fau' ),
                        'label'   => __( 'Ermöglicht es Beiträge als Top-Event zu deklarieren und entsprechende Optionen freizuschalten.',
                            'fau' ),
                    ...
                    'advanced_activate_page_langcode' => array(
                        ...
                        'label'   => __( 'Aktiviert die Möglichkeit, pro Seite eine eigene Inhaltssprache zu deklarieren, die von dem Rest des Webauftritts abweicht. Deklariert wird dabei die Überschrift der Seite und dessen Inhaltsbereich. Die restlichen Bestandteile, inkl. der Sidebar bleiben in der Sprache, mit der die gesamte Website gekennzeichnet wurde. Achtung: Diese Option arbeitet nicht mit dem Workflow-Plugin für mehrsprachigen Webauftritten zusammen. Diese Option sollte nur dann verwendet werden, wenn anderssprachige Seiten eine Ausnahme auf dem Webauftritt darstellen. Für umfangreiche Webauftritte in verschiedenen Sprachen sind eigene sprachspezifische Webauftritte vorzuziehen. Webauftritte, die unterhalb einer Domain mehrmals die Sprachen wechseln und eine Mischung im Navigationsmenu haben, haben zudem ein schlechteres Suchmaschinen-Ranking.',
                            'fau' ),
                    ...
                    'advanced_display_portalmenu_forceclick' => array(
                        ...
                        'label'   => __( 'Die Unterpunkte des Menüs öffnen sich nur bei einem Klick auf den jeweiligen Menüpunkt.',
                            'fau' ),
                    ...
                    'fallback_submenu_image' => array(
                        ...
                        'title'     => __( 'Thumbnail Ersatzbild', 'fau' ),
                        'label'     => __( 'Ersatzbild für den Fall, daß eine verlinkte Seite kein eigenes Artikelbild definiert hat.',
                            'fau' ),
                        'parent'    => 'contentmenus',
                    ...
                    'advanced_page_sidebar_titleabove' => array(
                        ...
                        'label'   => __( 'Fragt ein eigenes Titelfeld über den Texteditor zum Text oben ab (Titel können allerdings auch im Editorfeld eingegeben werden)',
                            'fau' ),
                    ...
                    'advanced_page_sidebar_titlebelow' => array(
                        ...
                        'label'   => __( 'Fragt ein eigenes Titelfeld über den Texteditor zum Text unten ab (Titel können allerdings auch im Editorfeld eingegeben werden)',
                            'fau' ),
                    ...
                    'advanced_page_sidebar_useeditor_textabove' => array(
                        ...
                        'label'   => __( 'Erlaubt die Nutzung des WYSWYG-Editors für die Eingabe von Text in der Sidebar. Dies schließt auch HTML-Tags mit Bildern und Links ein. Andernfalls ist nur ein Text mit Absätzen möglich.',
                            'fau' ),
                    ...
                    'advanced_page_sidebar_linkblock2_title'  => array(
                        ...
                        'label'   => __( 'Optionaler Titel über den zweiten Linkblock, wenn dieser belegt ist.',
                            'fau' ),
                    ...
                    'advanced_page_sidebar_linkblock2_number' => array(
                        ...
                        'label'   => __( 'Wieviele Links können maximal im zweiten Linkblock angegeben werden.',
                            'fau' ),
                    ...
                    'advanced_page_sidebar_wpsidebar'         => array(
                        ...
                        'label'   => __( 'Widgets die auf allen Seiten angezeigt werden sollen. Sollten Seitenspezifische Inhalte in der Sidebar angegeben worden sein, wird diese Sidebar darunter folgen. Diese Sidebar-Inhalte werden nicht auf Beiträgen gezeigt.',
                            'fau' ),
                    ...
                    'advanced_images_info_credits'  => array(
                        ...
                        'liste'   => array(
                            ...
                            '1' => __( 'Eingabefeld Beschreibung überschreibt IPTC und andere vorangige Felder.',
                                'fau' )
                        ),
                    ...
                    'advanced_display_hero_credits' => array(
                        'type'    => 'toggle',
                        'title'   => __( 'Copyright-Hinweis', 'fau' ),
                        'label'   => __( 'Auf der Startseite wird im Slider bzw. im Banner der Copyright-Hinweis des Bildes angezeigt, wenn vorhanden',
                            'fau' ),
            ...
            'debugmode' => array(
                ...
                'fields'     => array(
                    ...
                    'debug_website_fakultaet' => array(
                        ...
                        'label'      => __( 'Das Logo kann im Titel eine Farbe bekommen. Diese wird üblicherweise aus dem Theme-Child bestimmt, kann aber mit dieser Variante zu Testzwecken auch überschrieben werden. Diese Funktion wird im produktiven Betrieb nicht zur Verfügung stehen.',
                            'fau' ),
                        'liste'      => array(
                    ...
                    'debug_orgabreadcrumb'    => array(
                        ...
                        'label'      => __( 'Es wird eine organisatorische Breadcrumb simuliert und ausgegeben. Diese wird im produktiven Betrieb durch ein Plugin bereit gestellt werden.  Mit dieser Option kann man ohne Installation und Konfiguration des Plugins die Ausgabe mit Pseudodaten simulieren.',
                            'fau' ),
                        'default'    => false,
                        'parent'     => 'debugorgs',
                        'ifmodvalue' => true,
